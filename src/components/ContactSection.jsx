...
import { useToast } from "@/components/ui/use-toast"; // adjust import path as needed
import { useForm, ValidationError } from "@formspree/react";
import { useEffect } from "react";
import { cn } from "@/lib/utils"; // your utility className combiner

export const ContactSection = () => {
  const { toast } = useToast();
  const [state, handleSubmit] = useForm("mjkooona");
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:ranisipani879@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
